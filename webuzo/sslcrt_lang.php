...
//Theme Strings
$l['<title>'] = APP . ' - Certificate';
$l['lbl_head'] = 'Certificate';
...
$l['install_button'] = 'Upload';
$l['createcrt'] = 'Create';
$l['paste'] = 'Paste your Certificate here';
$l['or'] ='OR';
$l['choose_file'] = 'Choose the .crt file';
$l['note'] = '<strong>NOTE : </strong>You must generate or upload a key before generating any certificates.';
$l['cert_file'] = 'HOST';
$l['option'] = 'OPTION';
$l['record_del_conf'] = 'Do you want to delete this Certificate ?';
$l['delete'] = 'Certificate deleted successfully';
$l['some_error'] = 'There were some errors while deleting Certificate';
